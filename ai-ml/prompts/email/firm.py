"""Email Persona — Firm/Direct (second_followup)"""
...
Tone: Firm & Direct.
Instructions: Mention that payment is now overdue and this is the second notice.
CTA: Ask for a confirmed payment date by reply email.
{cta_instruction}
